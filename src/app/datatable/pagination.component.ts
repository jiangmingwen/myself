...
@Component({
  selector: 'wust-pagination',
  template: `
    <div class="wust-pagination">
      <ul>
        <wust-pagination-item [disabled]="isFirstPage" (click)="changePageToFirst()">
          <i class="fa fa-backward"></i>
        </wust-pagination-item>
        <wust-pagination-item [disabled]="isFirstPage" (click)="changePageToPrev()">
          <i class="fa fa-angle-left"></i>
        </wust-pagination-item>
        <wust-pagination-item *ngIf="startEllipsis" (click)="changePageToFirst()">
          1
        </wust-pagination-item>
        <wust-pagination-item [disabled]="true" *ngIf="startEllipsis">
          …
        </wust-pagination-item>
        <wust-pagination-item *ngFor="let page of _total;" [active]="page === activeIndex"
                              (click)="changePage(page)">
          {{page}}
        </wust-pagination-item>
        <wust-pagination-item [disabled]="true" *ngIf="endEllipsis">
          …
        </wust-pagination-item>
        <wust-pagination-item *ngIf="pageCount > maxPage && !isLastPage && endEllipsis"
                              (click)="changePage(pageCount)">
          {{pageCount}}
        </wust-pagination-item>
        <wust-pagination-item [disabled]="isLastPage" (click)="changePageToNext()">
          <i class="fa fa-angle-right"></i>
        </wust-pagination-item>
        <wust-pagination-item [disabled]="isLastPage" (click)="changePageToLast()">
...
@Component({
  selector: 'wust-pagination-item',
  template: `
    <li class="wust-pagination-item" [class.wust-pagination-active]="active"
        [class.wust-pagination-disabled]="disabled">
